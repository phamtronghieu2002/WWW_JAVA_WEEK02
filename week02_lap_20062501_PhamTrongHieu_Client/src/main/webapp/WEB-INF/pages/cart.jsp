                    ...
                    <div class="row d-flex justify-content-center align-items-center h-100">
                        <div class="col-10">
                            ...
                            <%
                                ...
                                ArrayList<Product> productList   = (ArrayList<Product>) request.getAttribute("carts");
                                ...
                                <div class="card-body p-4">
                                    <div class="row d-flex justify-content-between align-items-center">
                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                            <img
                                                    src="<%=product.getImages().get(0).getPath()%>"
                                                    class="img-fluid rounded-3" alt="Cotton T-shirt">
                                        </div>
                                        <div class="col-md-3 col-lg-3 col-xl-3">
                                            <p class="lead fw-normal mb-2"><%=product.getName()%></p>
                                            <p><span class="text-muted">desc: <%=product.getDescription()%></span></p>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                            <h5 class="mb-0"><%=product.getPrices().get(0).getPrice()%></h5>
                                        </div>
                                        <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                            <a href="CartController?action=deleteCart&id=<%=product.getProductId()%>" class="text-danger"><i class="fas fa-trash fa-lg"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
